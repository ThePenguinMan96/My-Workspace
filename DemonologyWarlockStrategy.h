...
public:
    ...
    std::string const getName() override { return "demonology"; }
...
public:
    ...
    void InitTriggers(std::vector<TriggerNode*>& triggers) override;
    std::string const getName() override { return "demonology aoe"; }
};
...
public:
    ...
    void InitTriggers(std::vector<TriggerNode*>& triggers) override;
    std::string const getName() override { return "meta melee aoe"; }
};

class WarlockTankStrategy : public CombatStrategy
{
public:
    WarlockTankStrategy(PlayerbotAI* botAI);

    void InitTriggers(std::vector<TriggerNode*>& triggers) override;
    std::string const getName() override { return "warlock tank"; }
};
