...
void GenericWarlockNonCombatStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode("no soulstone", NextAction::array(0, new NextAction("create soulstone", 13.0f), nullptr)));
    triggers.push_back(new TriggerNode("soulstone", NextAction::array(0, new NextAction("soulstone", 13.0f), nullptr)));
    ...
    {
        triggers.push_back(new TriggerNode("no firestone", NextAction::array(0, new NextAction("create firestone", 13.0f), nullptr)));
        triggers.push_back(new TriggerNode("firestone", NextAction::array(0, new NextAction("firestone", 13.0f), nullptr)));
    }
